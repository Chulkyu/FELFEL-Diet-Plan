...
import { UserProfile, NutritionData, ScannedFoodItem, MealSuggestion, NutrientKey } from './types';
import { calculateDailyGoals } from './services/nutritionService';
import { analyzeFoodLabel, recommendMeals } from './services/geminiService';
import { FireIcon, ProteinIcon, CarbIcon, FatIcon, CameraIcon, LightbulbIcon } from './components/icons';
